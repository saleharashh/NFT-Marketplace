          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {array.map((i) => (
              <Link
                href={"/artist"}
                key={i}
                className="flex lg:flex-col  lg:items-center lg:justify-center w-full items-center gap-3 bg-gray-800 rounded-lg px-4 py-2 bg-secondary-background"
              >
                ...
                <div className=" flex flex-col items-center justify-center gap-2">
                  ...
                  <div className="flex flex-row">
                    <p className="text-secondary-text text-sm">
                      Total Sales:{" "}
                      <span className="text-white font-medium">34.53 ETH</span>
                    </p>
                  </div>
                </div>
              </Link>
